               ...
               <Main className='flex flex-col items-center justify-start'>
                    <div className='max-w-2xl'>
                         <Alert>
                              ...
                              <AlertDescription>
                                   <p className='text-balance'>
                                        You need to generate a publishable key from Clerk and put it inside the <code className={codeBlock}>.env</code> file.
                                   </p>
                              </AlertDescription>
                         </Alert>
                         ...
                         <Alert>
                              ...
                              <AlertDescription>
                                   <p className='text-balance'>
                                        The Clerk integration lives entirely inside <code className={codeBlock}>src/routes/clerk</code>. If you plan to use
                                        Clerk as your auth service, you might want to place <code className={codeBlock}>ClerkProvider</code> at the root route.
                                   </p>
                                   <p>
                                   ...
                                   <p className='mt-2 text-sm'>This setup is modular by design and won't affect the rest of the application.</p>
                              </AlertDescription>
                         </Alert>
                    </div>
               </Main>
