...
import { UsersDialogs } from '@/develop/(views)/users/components/users-dialogs'
import { UsersPrimaryButtons } from '@/develop/(views)/users/components/users-primary-buttons'
import { UsersProvider } from '@/develop/(views)/users/components/users-provider'
import { UsersTable } from '@/develop/(views)/users/components/users-table'
import { users } from '@/develop/(views)/users/data/users'
                                   ...
                                   <div>
                                        ...
                                        <div className='flex gap-1'>
                                             ...
                                             <LearnMore open={opened} onOpenChange={setOpened} contentProps={{ side: 'right' }}>
                                                  ...
                                                  <p className='mt-4'>
                                                       You can sign out or manage/delete your account via the User Profile menu in the top-right corner of the
                                                       page.
