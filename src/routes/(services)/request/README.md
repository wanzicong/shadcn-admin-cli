...
```typescript
import { get } from '@/routes/(services)/request'
...
```typescript
import { post } from '@/routes/(services)/request'
...
```typescript
import { put, patch, del } from '@/routes/(services)/request'
...
```typescript
import { upload } from '@/routes/(services)/request'
...
```typescript
import { download } from '@/routes/(services)/request'
